...
2. PreviewMiddleware, a pass-through, keeps PreviewManager in the chain; ScopedQuery pulls the preview state via Injector
...
| `QueryType` | Root query with 13 entry points |
